...
class Sheep:
    ...
    def __init__(self, id_number, breed, age, health_issues, weekly_weight, feed_consumed, weekly_wool_yield=0):
        ...
        self.weekly_wool_yield = weekly_wool_yield  # Amount of wool collected weekly
    ...
    def get_weekly_wool_yield(self):
        """Return the weekly wool yield of the sheep."""
        return self.weekly_wool_yield
    ...
    def set_weekly_wool_yield(self, wool_amount):
        """Update the weekly wool yield of the sheep."""
        self.weekly_wool_yield = wool_amount
